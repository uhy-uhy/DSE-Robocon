...
static int tailRunAngle = 67;		// テール走行時テール角度（TODO:要調整）
// PID制御（差分記録用）
...
static void LookUpGate(int forward, int turn);
...
// 概要 : ルックアップゲートを攻略する
//*****************************************************************************
void LookUpGate(int forward, int turn)
{
	// シーン内状態
	static LookUpState State = TAIL_RUN;
	
//	// 走行距離測定用変数
//	static int mMileage = dist;
...
//	int tailAngle =  - ev3_motor_get_counts(tail_motor);
//	
//	int RADIUS = 80;
//	float PI = 3.14159;
//	
...
//	case STRAIGHT:
//		// 直進
//		motorParam[0] = 30;// TODO
//		motorParam[1] = 30;// TODO
//		
//		// ゲートを超えた場合
